              ...
              slivers: [
                ...
                StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (ctx, snap) {
                    ...
                    final mockFriends = [
                      {'name': 'ShadowReaper', 'badge': 'PRO',
                        'tier': 'Diamond Tier • Level 84', 'emoji': '🤖'},
                      {'name': 'Luna_Cyber', 'badge': 'MVP',
                        'tier': 'Master Tier • Level 102', 'emoji': '🧙'},
                    ];
                              ...
                              children: [
                                Text('Find Facebook Friends',
                                    style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.w700,
                                        fontSize: 14)),
                                Text('Sync contacts to play with friends',
                                    style: TextStyle(
