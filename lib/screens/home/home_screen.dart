                  ...
                  child: SizedBox(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance
                          ...
                          .snapshots(),
                      builder: (ctx, snap) {
                        // Use Firestore docs if available, else fall back to mock
                        final docs = snap.hasData && snap.data!.docs.isNotEmpty
                            ? snap.data!.docs
                        ...
                        return ListView.builder(
                          ...
                          padding: const EdgeInsets.symmetric(horizontal: 16),
                          itemCount: docs.length,
                          itemBuilder: (_, i) => _GameCard(data: docs[i]),
                        );
                      },
                    ),
                  ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(value,
              style: const TextStyle(
                  color: kTextPri, fontSize: 18, fontWeight: FontWeight.w800)),
          const SizedBox(height: 2),
